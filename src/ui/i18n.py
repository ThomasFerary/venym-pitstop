...
TRANSLATIONS = {
    "fr": {
        ...
        "global_settings": "Reglages globaux",
        "inverted_pedals": "Pedales inversees (swap connecteurs gauche/droite)",
        "flicker_brake": "Clignotement LEDs frein au-dela de :",
        "led_max_intensity": "Intensite max LEDs :",
        "flicker_abs": "Clignotement LEDs frein via signal ABS (telemetrie jeu)",
        "led_color_max": "100%",
        "led_color_min": "0%",
        "not_implemented": "Protocole firmware non identifie — en attente de reverse engineering",
    },
    "en": {
        "app_title": "Venym PitStop",
        ...
        "inverted_pedals": "Inverted pedals (swap left/right connectors)",
        "flicker_brake": "Flicker brake LEDs beyond:",
        "led_max_intensity": "LEDs max intensity:",
        "flicker_abs": "Flicker brake LEDs using ABS signal from game telemetry",
        "led_color_max": "100%",
        "led_color_min": "0%",
        "not_implemented": "Firmware protocol not identified — pending reverse engineering",
    },
}
